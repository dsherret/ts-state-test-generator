...
export class TestGenerator {
    ...
    addIgnorePropertyTransform(condition: (propertyDef: typeInfo.ClassPropertyDefinition | typeInfo.InterfacePropertyDefinition, parent?: typeInfo.ClassDefinition | typeInfo.InterfaceDefinition | undefined) => boolean): void;
    addIgnoreTypeTransform(condition: (typeDef: typeInfo.TypeDefinition) => boolean): void;
